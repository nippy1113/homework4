...
public class DriverManager {
     ...
     *
     * @param gecko - переменная firefox из файла application.properties в классе {@link utils.PropConst}
     * @param chrome - переменная chrome из файла application.properties в классе {@link utils.PropConst}
     */
            ...
            case "remote":
                ...
                try {
                    driver = new RemoteWebDriver(
                            URI.create("http://161.35.194.216:8080/#/").toURL(),
                            capabilities);
